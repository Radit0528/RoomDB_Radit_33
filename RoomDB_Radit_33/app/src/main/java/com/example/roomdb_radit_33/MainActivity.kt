package com.example.roomdb_radit_33
...
import com.example.roomdb_radit_33.room.Constant
import com.example.roomdb_radit_33.room.Movie
import com.example.roomdb_radit_33.room.MovieDb
...
class   MainActivity : AppCompatActivity() {
    ...
    private fun deleteDialog(movie: Movie) {
        ...
        alertDialog.apply {
            setTitle("Konfirmasi")
            setMessage("Yakin mau dihapus nih? ${movie.title}?")
